...
class Constants {
    ...
    let MAIN_CATEGORIES = ["priroda","banje","gradovi","građevine","kultura","zanimljivosti","sport, rekreacija","turist-info centri","smeštaj","ugostiteljstvo","šoping","korisne informacije","sve kategorije"]
    let MAIN_CATEGORIES_ENG = ["nature","spa","cities","buildings","culture","interesting","sport","tourist-info centers","accommodation","catering","shopping","useful information","all categories"]
    let MAIN_CATEGORIES_CIR = ["природа","бање","градови","грађевине","култура","занимљивости","спорт, рекреација","турист-инфо центри","смештај","угоститељство","шопинг","корисне информације","све категорије"]
